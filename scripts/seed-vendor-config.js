...
const SHOPS = {
  ...
  brimor: {
    ...
    items: [
      { id: "Candy", name: "Candy", price: 250000, roleId: "1417273583054360602", description: "Sweet and playful, a taste of delight." },
      { id: "Moon", name: "Moon", price: 300000, roleId: "1417273968745906339", description: "Bathed in silver light and quiet power." },
      { id: "Dragon", name: "Dragon", price: 350000, roleId: "1417214070263779348", description: "Ancient strength born from flame and legend." },
      { id: "Darkness", name: "Darkness", price: 400000, roleId: "1417273816475762770", description: "Calm in shadow, unseen yet ever near." },
      { id: "Vampire", name: "Vampire", price: 450000, roleId: "1417265958501744753", description: "Elegant hunger bound by eternal night." },
      { id: "Sapphire", name: "Sapphire", price: 500000, roleId: "1417296847550283846", description: "Cool wisdom glimmering like ocean glass." },
      { id: "Emerald", name: "Emerald", price: 550000, roleId: "1417297359066366122", description: "Life's quiet pulse wrapped in green flame." },
      { id: "Opal", name: "Opal", price: 600000, roleId: "1417298101433008239", description: "Shifting hues of truth and illusion." },
      { id: "Ruby", name: "Ruby", price: 650000, roleId: "1417297864366886953", description: "Heartfire burning with unyielding passion." },
      { id: "Diamond", name: "Diamond", price: 750000, roleId: "1416924911116750899", description: "Enduring light forged through pressure and time." },
      { id: "Phantom", name: "Phantom", price: 850000, roleId: "1419173035185016852", description: "Fleeting soul between light and void." },
      { id: "Titan", name: "Titan", price: 950000, roleId: "1419173032710111242", description: "Unshaken might carved from the earth." },
      { id: "Royal", name: "Royal", price: 1050000, roleId: "1419173030222889053", description: "Grace under weight, crowned by resolve." },
      { id: "Special", name: "Special", price: 1150000, roleId: "1419173027224096870", description: "A name whispered long after silence." },
      { id: "Mythical", name: "Mythical", price: 1250000, roleId: "1419173019724808333", description: "Half truth, half dream, fully eternal." },
      { id: "CustomRole", name: "Custom Role", price: 1500000, roleId: "1419769254076743730", description: "Your own mark upon the realm." },
    ],
  },
  broker: {
    title: "Broker",
