...
import { getVaelcroftLore, saveVaelcroftLore } from '@/lib/admin/vaelcroft-lore';
import { coerceLore, type VaelcroftLore } from '@/lib/admin/vaelcroft-lore-types';
...
function sanitize(lore: VaelcroftLore): VaelcroftLore {
...
export async function GET() {
  ...
  try {
    const lore = await getVaelcroftLore();
    return NextResponse.json({ lore });
  } catch (e) {
    console.error('[vaelcroft/lore GET]', e);
...
export async function PUT(req: NextRequest) {
  ...
  try {
    ...
    console.error('[vaelcroft/lore PUT]', e);
    return NextResponse.json(
