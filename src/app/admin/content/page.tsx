  ...
  return (
    <>
      <div className="admin-page-header">
        <h1 className="admin-page-title"><span className="emoji-float">✏️</span> Website</h1>
        <p className="admin-page-subtitle">
          Manage website content, inline text, and footer
        </p>
      </div>
      ...
      <div className="admin-tabs">
        ...
        <button className={`admin-tab ${tab === 'footer' ? 'admin-tab-active' : ''}`} onClick={() => setTab('footer')}>
          Footer
        </button>
      </div>
