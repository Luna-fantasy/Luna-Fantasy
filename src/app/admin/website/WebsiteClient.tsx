...
export default function WebsiteClient({ factions }: { factions: FactionMeta[] }) {
    ...
    <div>
      ...
      >
        <button
          ...
          className={`av-inbox-chip${tab === 'editor' ? ' av-inbox-chip--active' : ''}`}
        ...
        <button
          ...
          className={`av-inbox-chip${tab === 'characters' ? ' av-inbox-chip--active' : ''}`}
      ...
      {tab === 'characters' && <CharactersPanel factions={factions} />}
    </div>
  );
}
