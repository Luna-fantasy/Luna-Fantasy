    ...
    <>
      ...
      <section className="cards-hero">
        ...
        <div className="cards-hero-content">
          <span className="hero-badge"><E ns="grandFantasyPage" k="heroSubtitle">{t('heroSubtitle')}</E></span>
          <h1 className="cards-hero-title"><E ns="grandFantasyPage" k="heroTitle">{t('heroTitle')}</E></h1>
          <p className="cards-hero-desc"><E ns="grandFantasyPage" k="subtitle">{t('subtitle')}</E></p>
      ...
      {/* What Is Grand Fantasy */}
      <section className="cards-info-section">
        <div className="wrap">
          <div className="cards-info-grid">
            <div className="cards-info-card">
              <h3><E ns="grandFantasyPage" k="whatTitle">{t('whatTitle')}</E></h3>
              <p><E ns="grandFantasyPage" k="whatDesc">{t('whatDesc')}</E></p>
            </div>
            <div className="cards-info-card">
              <h3><E ns="grandFantasyPage" k="howTitle">{t('howTitle')}</E></h3>
              <p><E ns="grandFantasyPage" k="howDesc">{t('howDesc')}</E></p>
            </div>
          </div>

          <div className="rules-section">
            <ul className="rules-list">
              <li><E ns="grandFantasyPage" k="rules.rule1">{t('rules.rule1')}</E></li>
              <li><E ns="grandFantasyPage" k="rules.rule2">{t('rules.rule2')}</E></li>
              <li><E ns="grandFantasyPage" k="rules.rule3">{t('rules.rule3')}</E></li>
              <li><E ns="grandFantasyPage" k="rules.rule4">{t('rules.rule4')}</E></li>
              <li><E ns="grandFantasyPage" k="rules.rule5">{t('rules.rule5')}</E></li>
            </ul>
          </div>
        </div>
      </section>
