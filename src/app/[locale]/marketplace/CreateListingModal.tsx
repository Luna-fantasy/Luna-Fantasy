  ...
  const handleSubmit = async () => {
    ...
    try {
      const res = await fetch('/api/marketplace/list', {
        ...
        body: JSON.stringify({ cardId: selectedCard.id, price: priceNum }),
      });
  ...
  return (
    <div className="create-listing-overlay" onClick={onClose}>
      <div className="create-listing-modal" onClick={(e) => e.stopPropagation()}>
        ...
        <h3 className="create-listing-title">{t('sellCard')}</h3>
          ...
          <div className="create-listing-confirm">
            ...
            <div className="create-listing-preview">
              ...
              <div className="create-listing-preview-info">
                ...
                <span className={`create-listing-preview-rarity rarity-${rKey}`}>
                  {selectedCard.rarity}
                </span>
            ...
            <div className="create-listing-price-input">
              <label className="create-listing-label">{t('setPrice')}</label>
            ...
            <div className="create-listing-actions">
              <button
                ...
                onClick={() => { setSelectedCard(null); setPrice(''); setError(''); }}
              >
                {t('back')}
              </button>
              <button
              ...
              >
                {submitting ? t('listing') : t('listForSale')}
              </button>
            </div>
          </div>
        )}
