    ...
    <div className="bank-dashboard">
      ...
      <section className="bank-section">
        <div className="bank-section-header">
          ...
          <h2 className="bank-section-title"><E ns="bankPage" k="salary.title">{t('salary.title')}</E></h2>
        </div>
        <div className="salary-grid">
          <DailyClaimCard
            ...
            dailyBase={bankData.config?.dailyBase}
            vipBonus={bankData.config?.dailyVipBonus}
            cooldownMs={bankData.config?.dailyCooldownMs}
          />
          <MonthlySalaryCard
            roles={bankData.roles}
            locale={locale}
            monthlyAmount={bankData.config?.monthlyAmount}
          />
        </div>
      </section>
      ...
      <InvestmentTracker
        ...
        minAmount={bankData.config?.investmentMinAmount}
        maturityMs={bankData.config?.investmentMaturityMs}
        earlyFee={bankData.config?.investmentEarlyFee}
        profitRate={bankData.config?.investmentProfitRate}
        depositLockMs={bankData.config?.investmentDepositLockMs}
      />
      ...
      <div className="bank-sections">
          ...
          <div className="salary-grid">
            <div className="salary-card">
              <div className="salary-card-header">
                <span className="salary-card-title"><E ns="bankPage" k="salary.daily.title">{t('salary.daily.title')}</E></span>
                <div className="salary-timer">
                  <span className="timer-icon"></span>
                  <span><E ns="bankPage" k="salary.daily.resetTimer">{t('salary.daily.resetTimer')}</E></span>
                </div>
              </div>
              <p className="salary-desc"><E ns="bankPage" k="salary.daily.desc">{t('salary.daily.desc')}</E></p>
              <div className="salary-amount">
                <span className="salary-value">{formatFullNumber(data.salary.daily.basePay)}</span>
                <span className="salary-currency"><E ns="bankPage" k="currency">{t('currency')}</E></span>
              </div>
              <div className="salary-bonus">
                <span className="bonus-icon">+</span>
                <span><E ns="bankPage" k="salary.daily.vipBonus">{t('salary.daily.vipBonus')}</E>: +{formatFullNumber(data.salary.daily.vipBonus)} <E ns="bankPage" k="currency">{t('currency')}</E></span>
              </div>
              <p className="vip-note">
                <E ns="bankPage" k="salary.daily.vipNote">{t('salary.daily.vipNote')}</E>{' '}
                <a href="#vip-section" className="vip-note-link"><E ns="bankPage" k="vip.actionBtn">{t('vip.actionBtn')}</E></a>
              </p>
              <a href="https://discord.com/channels/1243327880478462032/1450597284600615062" target="_blank" rel="noopener noreferrer" className="section-action-btn">
                <E ns="bankPage" k="salary.daily.claimBtn">{t('salary.daily.claimBtn')}</E>
              </a>
            </div>
            <div className="salary-card">
              <div className="salary-card-header">
                <span className="salary-card-title"><E ns="bankPage" k="salary.monthly.title">{t('salary.monthly.title')}</E></span>
              </div>
              <p className="salary-desc"><E ns="bankPage" k="salary.monthly.desc">{t('salary.monthly.desc')}</E></p>
              <div className="salary-amount">
              ...
              <div className="eligible-roles">
                <div className="roles-category">
                  <div className="roles-category-title"><E ns="bankPage" k="salary.monthly.staffRoles">{t('salary.monthly.staffRoles')}</E></div>
                ...
                <div className="roles-category">
                  <div className="roles-category-title"><E ns="bankPage" k="salary.monthly.specialRoles">{t('salary.monthly.specialRoles')}</E></div>
                ...
                <div className="roles-tip"><E ns="bankPage" k="salary.monthly.tip">{t('salary.monthly.tip')}</E></div>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="bank-section loan-section-with-image">
          <div className="loan-section-content">
            <div className="bank-section-header">
              ...
              <h2 className="bank-section-title"><E ns="bankPage" k="loans.title">{t('loans.title')}</E></h2>
            </div>
            <p className="section-desc"><E ns="bankPage" k="loans.desc">{t('loans.desc')}</E></p>
            <div className="loan-overview">
              <div className="loan-stat">
                <div className="loan-stat-label"><E ns="bankPage" k="loans.interest">{t('loans.interest')}</E></div>
                <div className="loan-stat-value interest">{data.loans.interestRate}%</div>
              </div>
              <div className="loan-stat">
                <div className="loan-stat-label"><E ns="bankPage" k="loans.vipInterest">{t('loans.vipInterest')}</E></div>
                <div className="loan-stat-value vip">{data.loans.vipInterestRate}%</div>
              </div>
              <div className="loan-stat">
                <div className="loan-stat-label"><E ns="bankPage" k="loans.deadline">{t('loans.deadline')}</E></div>
                <div className="loan-stat-value deadline">{data.loans.deadline} <E ns="bankPage" k="loans.days">{t('loans.days')}</E></div>
              </div>
            </div>
            <div className="loan-tiers-title"><E ns="bankPage" k="loans.tiers">{t('loans.tiers')}</E></div>
            ...
            <a href="https://discord.com/channels/1243327880478462032/1450597284600615062" target="_blank" rel="noopener noreferrer" className="section-action-btn">
              <E ns="bankPage" k="loans.actionBtn">{t('loans.actionBtn')}</E>
            </a>
          </div>
          <div className="loan-image-container" onClick={() => setIsLoanImageOpen(true)} role="button" tabIndex={0} onKeyDown={(e) => e.key === 'Enter' && setIsLoanImageOpen(true)}>
            <EImg editId="bank-loan-contract" src="/images/loan_contract.png" alt="Loan Contract" width={300} height={400} className="loan-contract-image" />
          </div>
        </section>
        ...
        <section id="vip-section" className="bank-section">
          <div className="bank-section-header">
            ...
            <h2 className="bank-section-title"><E ns="bankPage" k="insurance.title">{t('insurance.title')}</E></h2>
          </div>
          <div className="services-grid">
            <div className="service-card">
              <div className="service-card-header">
                <span className="service-card-icon protection-icon"></span>
                <span className="service-card-title"><E ns="bankPage" k="insurance.theftProtection">{t('insurance.theftProtection')}</E></span>
              </div>
              <p className="service-desc"><E ns="bankPage" k="insurance.theftDesc">{t('insurance.theftDesc')}</E></p>
              <div className="service-detail">
                <span className="service-detail-label"><E ns="bankPage" k="insurance.cost">{t('insurance.cost')}</E></span>
                <span className="service-detail-value cost">{formatFullNumber(data.insurance.theftProtection.cost)} <E ns="bankPage" k="currency">{t('currency')}</E></span>
              </div>
              <div className="service-detail">
                <span className="service-detail-label"><E ns="bankPage" k="insurance.effect">{t('insurance.effect')}</E></span>
              ...
              <a href="https://discord.com/channels/1243327880478462032/1450597284600615062" target="_blank" rel="noopener noreferrer" className="section-action-btn small">
                <E ns="bankPage" k="insurance.actionBtn">{t('insurance.actionBtn')}</E>
              </a>
            </div>
            <div className="service-card vip-card">
              <div className="service-card-header">
                <span className="service-card-icon vip-icon"></span>
                <span className="service-card-title"><E ns="bankPage" k="vip.title">{t('vip.title')}</E></span>
              </div>
              <p className="service-desc"><E ns="bankPage" k="vip.desc">{t('vip.desc')}</E></p>
              <div className="vip-how-to">
                <div className="vip-how-to-label"><E ns="bankPage" k="vip.howToJoin">{t('vip.howToJoin')}</E></div>
                <div className="vip-how-to-value">{formatFullNumber(data.vip.depositRequirement)}+ <E ns="bankPage" k="currency">{t('currency')}</E></div>
              </div>
              <div className="vip-benefits-title"><E ns="bankPage" k="vip.benefits">{t('vip.benefits')}</E></div>
              ...
              <a href="https://discord.com/channels/1243327880478462032/1450597284600615062" target="_blank" rel="noopener noreferrer" className="section-action-btn small vip">
                <E ns="bankPage" k="vip.actionBtn">{t('vip.actionBtn')}</E>
              </a>
            </div>
          </div>
        </section>
    ...
    <main>
      ...
      <section className="bank-hero">
        <div className="bank-hero-bg">
          <EImg editId="bank-hero-bg" source="r2" src="https://assets.lunarian.app/backgrounds/BankHero.png" alt="Luna Bank" fill priority className="bank-hero-bg-image" />
        </div>
        <div className="bank-hero-content">
          <h1 className="bank-hero-title"><E ns="bankPage" k="title">{t('title')}</E></h1>
          <p className="bank-hero-desc"><E ns="bankPage" k="subtitle">{t('subtitle')}</E></p>
          {!isLoggedIn && (
      ...
      <div className="wrap">
        {isLoggedIn && isLoading && (
          <div className="bank-loading">
            ...
            <span><E ns="bankPage" k="dashboard.loading">{t('dashboard.loading')}</E></span>
          </div>
        )}
        ...
        {isLoggedIn && error && !isLoading && (
          <div className="bank-error">
            ...
            <button className="section-action-btn" onClick={refetch}>
              <E ns="bankPage" k="dashboard.retry">{t('dashboard.retry')}</E>
            </button>
          </div>
        )}
