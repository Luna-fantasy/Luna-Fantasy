      ...
      <div className="trading-wrap">
        ...
        <div className="trading-stats-bar">
          <div className="trading-stat-item">
            <span className="trading-stat-label">{t('maxTrade')}</span>
            <span className="trading-stat-value accent">50,000</span>
          </div>
          <div className="trading-stat-item">
            <span className="trading-stat-label">{t('winChance')}</span>
            <span className="trading-stat-value win">50%</span>
          </div>
          <div className="trading-stat-item">
            <span className="trading-stat-label">{t('winReward')}</span>
            <span className="trading-stat-value win">+20%</span>
          </div>
          <div className="trading-stat-item">
            <span className="trading-stat-label">{t('lossPenalty')}</span>
            <span className="trading-stat-value loss">-30%</span>
          </div>
          <div className="trading-stat-item">
            <span className="trading-stat-label">{t('cooldown')}</span>
            <span className="trading-stat-value muted">4{t('hours')}</span>
          </div>
        </div>
        ...
        <div className="trading-warning-bar">
          ...
          <span className="trading-warning-text">{t('warning')}</span>
        </div>
        ...
        {!isLoggedIn ? (
          ...
          <div className={`trading-result ${result.won ? 'win' : 'loss'}`}>
            ...
            <div className="trading-result-balance">
              <span className="trading-result-balance-label">{t('newBalance')}</span>
          ...
          <div className="trading-interface">
            ...
            {balance !== null && (
              <div className="trading-balance">
                <span className="trading-balance-label">{t('balance')}</span>
                <span className="trading-balance-value">
                  {balance.toLocaleString()} <span className="trading-balance-currency">{t('currency')}</span>
                </span>
              </div>
            )}
            ...
            <div className="trading-amount-section">
              <div className="trading-amount-title">{t('selectAmount')}</div>
